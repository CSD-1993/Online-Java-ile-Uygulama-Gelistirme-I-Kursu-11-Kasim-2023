...
Dersler hafta içi __Cumartesi - Pazar__ günleri saat __13:00-00 – 17-00__ saatleri arasında __4__'er saat olarak yapılacaktır.


## Eğitim İçeriği
[__Eğitim içeriğini bu bağlantıdan görebilirsiniz.__](https://github.com/CSD-1993/Online-Java-ile-Uygulama-Gelistirme-I-Kursu-21-Ekim-2023/blob/main/kurs_icerigi.md)
...
## Format
+ *Java ile Uygulama Geliştirme Kursu* online olarak gerçek zamanlı verilmektedir. Derslerin izlenmesi için [Zoom](https://zoom.us/) yazılımı kullanılmaktadır. Ders sırasında öğrenciler eğitmene soru sorabilirler.
